...
const ReferCard = () => {
  return (
    <div className="bg-white shadow-md mx-auto rounded-xl w-[450px]">
            <a href="#">
                <img src={jackSon} alt="Product image" className="h-80 w-[450px] rounded-3xl object-cover rounded-t-xl"/>
            </a>
            <div className="px-5">
                <div className="flex justify-between items-center mt-5">
                    <h1 className="font-bold text-xl">Michael Jackson</h1>
                    <span className="font-bold text-xl">₹4,370</span>
                </div>
                <div>
                    <p className="mt-3">
                ...
                <div className="flex items-center my-3">
                    ...
                    <span className="font-bold text-xl">
                        <span className="text-primary-500">4.8</span> (89)
                    </span>
                </div>
